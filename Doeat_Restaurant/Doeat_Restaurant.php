<html>
	...
	<body style="overflow:auto;">
			...
			<select name = "Village" style="position:absolute; left:18.33333333333%; top:27.8125%; width:26.11111111111%; height:4.375%; font-size:24pt;"> 
				<option value="전체">전체</option>
				<option value="솔뫼">솔뫼</option>
				<option value="논골">논골</option>
			</select>
			
			<!-- 음식 분류 select 박스 크기, 위치, 폰트 크기, option 값 설정 -->
			<select name = "Food" style="position:absolute; left:50%; top:27.8125%; width:26.11111111111%; height:4.375%; font-size:24pt;">
				<option value="전체">전체</option>
            ...
            <tr>
                <td class="search"><a href="Doeat_Restaurant_Info.php">우일식당<img src="hansan.png" style="position:absolute;left:85%; top:20%; width:8%; height:70%;"></a></td>
            </tr>
            <tr>
                <td class="search"><a href="#">치킨 피자 나라<img src="hurry.png" style="position:absolute;left:85%; top:20%; width:8%; height:70%;"></a></td>
            </tr>
            <tr>
                <td class="search"><a href="#">순이네 분식<img src="ready.png" style="position:absolute;left:85%; top:20%; width:8%; height:70%;"></a></td>
            </tr>
        </table>
