<html>
	...
	<body style="overflow:auto;">
		...
		<!-- 예약 완료 문구 위치 및 크기 설정 -->
		<div style="position:absolute; left:32.5%; top:49%; font-size:30pt;">
			예약 완료되었습니다!
		</div>
		
		<!-- 예약 시간 텍스트 위치 및 크기 설정 -->
		<div style="position:absolute; left:26%; top:57%; font-size:30pt;">
		...
		<form>
			...
			<input type="text" name="time" value="11" size="3" style="position:absolute; left:52.5%; top:56.1%; width:8%; height:4.4%; font-size:50pt;" readonly> </input>
			
			<!-- 받아온 시간 사이에 들어갈 : 텍스트 위치 및 크기 설정 -->
			<div style="position:absolute; left:63%; top:56.3%; width:10%; height:4.4%; font-size:50pt;">
			:
			</div>

			<!-- 예약 시간 minute 받아오기 (읽기전용) -->
			<input type="text" name="minute" value="00" size="3" style="position:absolute; left:68%; top:56.1%; width:8%; height:4.4%; font-size:50pt;" readonly></input>
		</form>

		<!-- 예약 인원 텍스트 위치 및 크기 설정 -->
		<div style="position:absolute; left:29%; top:65%; font-size:30pt;">
			예약 인원&nbsp&nbsp&nbsp: 
		</div>

		<form>
			<!-- 예약 인원 받아오기 (읽기전용) -->
			<input type="text" name="time" value="2" size="3" style="position:absolute; left:56%; top:64%; width:8%; height:4.4%; font-size:50pt;" readonly> </input>
		</form>
		
		<!-- 받아온 예약 인원 뒤 명 텍스트 위치 및 크기 설정 -->
		<div style="position:absolute; left:67%; top:65%; font-size:30pt;">
			명
		</div>
		...
		<form>
		<input type="button" value="확인" onclick="location.href='../Doeat_Restaurant/Doeat_Restaurant_Info.php'" style="position:absolute; left:75%; top:80%; width:12%; height:4.21875%; font-size:28pt;  background-color:#ff9900; color:white;">
		</form>
