...
<body style="overflow:auto;">
    <ul>
        ...
        <!--하단 버튼-->
        <form>
            <input type="button" value="작성완료" style="position:absolute; left:23.77777777778%; top:80%; width:53.05555555556%; height:4.21875%; font-size:30px; background-color:#ff9900; color:white;">
        </form>
    </ul>
