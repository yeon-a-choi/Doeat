...
<body style="overflow:auto;">
    <ul>
        ...
        <!--하단 버튼-->
         <form>
             <input type="button" onclick="location.href='Doeat_Notice_User.php'" value="확인" style="position:absolute; left:23.77777777778%; top:80%; width:53.05555555556%; height:4.21875%; font-size:30px; background-color:#ff9900; color:white;">
         </form>
    </ul>
