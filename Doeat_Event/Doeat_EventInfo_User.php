    ...
    <ul>
        ...
        <table style="font-size:24pt; position:absolute; left:0%; top:18.125%; width:100%; height:2.5%;">
            <tr align="center">
                ...
                <td style="border-bottom:3px solid #ff9900"><a href="../Doeat_Event/Doeat_Event_User.php">이벤트</a></td>
            </tr>
        </table>
        <!--이벤트 목록-->
        <table class="downmenu" style="position:absolute; left:0%; top:34%; width:100%; height:auto;">
            <tr>
                <td class="favorite">우일식당 신메뉴 출시&nbsp;<p class="date">2019.10.05</p></td>
            </tr>
            <tr>
                <td class="event" style="position:fixed; height:35%">
                    <p class="img_align"><img src="main_eventimg.jpg" style="width:66%;height:55%">&nbsp;</p>
                    <p class="info">따끈따끈한 <span style="color:#ff9900;">부대찌개</span> 출시<br />한 그릇 드시러 오세요~~~</p>
                </td>
            </tr>
        </table>
        <form>
            <input type="button" value="확인" onclick="location.href='Doeat_Event_User.php'" style="position:absolute; left:23.77777777778%; top:80%; width:53.05555555556%; height:4.21875%; font-size:30px; background-color:#ff9900; color:white;">
        </form>
    </ul>
